...
export class AuthService {
  private readonly isLoggedInUrl = 'http://127.0.0.1:5002/api/is_logged_in';
  ...
  logout(): void {
    ...
    this.http.get('http://localhost:4200//logout').subscribe(() => {
      // Redirect to login or home page after successful logout
      this.router.navigate(['http://127.0.0.1:5002/login']); // Replace '/login' with your login route
    });
  }
